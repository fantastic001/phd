...
\begin{frame}{Temporal Evolution: Repartitioning Rate -- CITESEER}
  \centering
  \includegraphics[height=0.75\textheight]{citeseer-repartitions.png}
\end{frame}

\begin{frame}{Temporal Evolution: Repartitioning Rate -- DBLP}
  \centering
  \includegraphics[height=0.75\textheight]{dblp-repartitions.png}
\end{frame}

\begin{frame}{Temporal Evolution: Repartitioning Rate -- AstroPh}
  \centering
  \includegraphics[height=0.75\textheight]{astroph-repartitions.png}
\end{frame}

\begin{frame}{Temporal Evolution: Repartitioning Rate -- AS-Oregon}
  \centering
  \includegraphics[height=0.75\textheight]{as-oregon-repartitions.png}
\end{frame}

\begin{frame}{Temporal Evolution: Repartitioning Rate -- Enron}
  \centering
  \includegraphics[height=0.62\textheight]{enron-repartitions.png}

  \footnotesize Across all datasets, the repartitioning rate decays rapidly after an initial warm-up and stays below 20\% -- assignments stabilize quickly.
\end{frame}
